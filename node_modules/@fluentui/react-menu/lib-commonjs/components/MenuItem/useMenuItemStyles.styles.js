...
_export(exports, {
    ...
    useMenuItemStyles_unstable: ()=>useMenuItemStyles_unstable
});
...
const useStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    h: [
        ...
        ".fp258yr:hover .fui-MenuItem__icon{color:var(--colorNeutralForeground2BrandSelected);}",
...
const useMenuItemStyles_unstable = (state)=>{
    ...
    state.root.className = (0, _react.mergeClasses)(menuItemClassNames.root, styles.root, styles.focusIndicator, state.disabled && styles.disabled, state.root.className);
    if (state.content) {
        state.content.className = (0, _react.mergeClasses)(menuItemClassNames.content, styles.content, state.content.className);
    }
    if (state.checkmark) {
        state.checkmark.className = (0, _react.mergeClasses)(menuItemClassNames.checkmark, state.checkmark.className);
    }
    if (state.secondaryContent) {
        state.secondaryContent.className = (0, _react.mergeClasses)(menuItemClassNames.secondaryContent, !state.disabled && styles.secondaryContent, state.secondaryContent.className);
    }
    if (state.icon) {
        state.icon.className = (0, _react.mergeClasses)(menuItemClassNames.icon, styles.icon, state.icon.className);
    }
    if (state.submenuIndicator) {
        state.submenuIndicator.className = (0, _react.mergeClasses)(menuItemClassNames.submenuIndicator, styles.submenuIndicator, state.submenuIndicator.className);
    }
