...
_export(exports, {
    popoverSurfaceClassNames: ()=>popoverSurfaceClassNames,
    arrowHeights: ()=>arrowHeights,
    usePopoverSurfaceStyles_unstable: ()=>usePopoverSurfaceStyles_unstable
});
...
const usePopoverSurfaceStyles_unstable = (state)=>{
    ...
    state.root.className = (0, _react.mergeClasses)(popoverSurfaceClassNames.root, styles.root, state.size === 'small' && styles.smallPadding, state.size === 'medium' && styles.mediumPadding, state.size === 'large' && styles.largePadding, state.appearance === 'inverted' && styles.inverted, state.appearance === 'brand' && styles.brand, state.root.className);
