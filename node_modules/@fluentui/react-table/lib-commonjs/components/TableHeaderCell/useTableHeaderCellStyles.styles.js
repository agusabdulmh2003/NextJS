...
_export(exports, {
    ...
    tableHeaderCellClassNames: ()=>tableHeaderCellClassNames,
    useTableHeaderCellStyles_unstable: ()=>useTableHeaderCellStyles_unstable
});
 ...
 */ const useStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    d: [
        ...
        ".fhix6mv[data-fui-focus-within]:focus-within{outline-width:2px;}",
        ".fha7anx[data-fui-focus-within]:focus-within{outline-style:solid;}",
        ".f1fmzww4[data-fui-focus-within]:focus-within{outline-color:var(--colorStrokeFocus2);}",
        ".fs9qmxf[data-fui-focus-within]:focus-within{border-bottom-right-radius:var(--borderRadiusMedium);}",
        ".f187m4uq[data-fui-focus-within]:focus-within{border-bottom-left-radius:var(--borderRadiusMedium);}",
